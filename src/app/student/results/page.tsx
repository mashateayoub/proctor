  ...
  return (
    <div className="w-full">
        <div className="max-w-[1024px] mx-auto">
          ...
          {loading ? (
             <p className="text-center text-caption text-black/50 dark:text-white/50 py-12">Fetching secure records...</p>
          ) : results.length === 0 ? (
             <div className="text-center py-24 bg-white dark:bg-[#1d1d1f] rounded-[12px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               {results.map((r) => (
                 <Card key={r.id} elevated className="p-8 bg-white dark:bg-[#272729]">
